...
protoc -I=$proto_imports --doc_out=docs/api  --doc_opt=markdown,topo.md --gogofaster_out=Mgoogle/protobuf/duration.proto=github.com/gogo/protobuf/types,import_path=topo,plugins=grpc:. api/topo/*.proto
