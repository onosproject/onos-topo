...
// getConfigCommand returns a topo configuration command
func getConfigCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "config",
		Short: "Read and update the topo configuration",
	}
...
// getConfigGetCommand returns a topo configuration get command
...
// getConfigSetCommand returns a topo configuration set command
