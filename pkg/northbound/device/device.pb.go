...
const (
	...
	Protocol_GNMI Protocol = 0
	// P4RUNTIME protocol reference
	Protocol_P4RUNTIME Protocol = 1
	// GNOI protocol reference
	Protocol_GNOI Protocol = 2
	// L3 reachability reference
	Protocol_L3_REACHABILITY Protocol = 3
)
...
const (
	// AVAILABLE indicates the corresponding protocol is connected on this device
	State_AVAILABLE State = 0
	// UNAVAILABLE indicates the corresponding protocol is not connected on this device
	State_UNAVAILABLE State = 1
	// CONNECTING indicates the corresponding protocol is connecting phase on this device
	State_CONNECTING State = 2
)
...
type ProtocolState struct {
	...
	State    State    `protobuf:"varint,2,opt,name=state,proto3,enum=topo.device.State" json:"state,omitempty"`
}
...
func (m *ProtocolState) GetProtocol() Protocol {
	...
	return Protocol_GNMI
}

func (m *ProtocolState) GetState() State {
	if m != nil {
		return m.State
	}
...
func init() {
	...
	proto.RegisterEnum("topo.device.State", State_name, State_value)
...
var fileDescriptor_b9d152c21573e6ba = []byte{
	...
	,
}
